      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="pb-8">
          ...
          <div className="flex justify-center items-center">
            <from action="https://getform.io/f/mepNy2bM" method="POST" className="flex flex-col w-full md:w-1/2">
              ...
              text-white focus:outline-none">
                    ...
                    <textarea name="message" placeholder="Enter your message"rows="10" className="p-2 bg-transparent border-2 rounded-md text-white focus:outline">
                </textarea>
